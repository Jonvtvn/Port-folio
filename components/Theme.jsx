    ...
    return (
        <>
            <div className="toggle-switch relative inline-flex" role="tooltip" >
                <button data-type="theme" id="lightdark" className="relative block material-symbols-outlined w-12 h-12 gap-x-2 rounded-full text-lg font-medium bg-neutral-700 text-white dark:text-primary-200">
